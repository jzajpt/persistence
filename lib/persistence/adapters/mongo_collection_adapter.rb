...
require 'persistence/adapters/abstract_collection_adapter'

module Persistence
  module Adapters
    class MongoCollectionAdapter < AbstractCollectionAdapter
      ...
      def collection
        @_collection = self.database_adapter.database[@collection_name]
      end
