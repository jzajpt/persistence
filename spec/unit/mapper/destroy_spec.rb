...
describe Persistence::Mapper::Destroy do
  ...
  describe '#destroy' do
    ...
    context "given object with ID" do
      let(:object) { mock "object", id: id }

      it "does not try to find object" do
        persistence.should_not_receive :find
        persistence.destroy object
      end
